  ...
  options.modules.services.ollama = {
    ...
    home = mkOption {
      description = ''
        ...
        Created and chowned to the ollama user via systemd-tmpfiles so
        a fresh ZFS-mounted directory ends up with the correct ownership
